...
cumulative_df = cumulative_savings.merge(
    cumulative_sp500, left_index=True, right_index=True, how="inner"
)
...
if final_sp500 > final_savings:
    st.write(
        f"The S&P 500 accumulated to **{final_sp500:.2f}** compared to the savings account's **{final_savings:.2f}**. "
    ...
    st.write(
        f"The savings account accumulated to {final_savings:.2f} compared to the S&P 500's {final_sp500:.2f}. "
